<powershell>
 ...
 $env:CHEF_SERVER_NAME = "Aaron-Eli-Test" # Name of your Chef Server
 $env:CHEF_SERVER_ENDPOINT = "aaron-eli-test-cgnvf9tw5oa4l1v4.us-east-1.opsworks-cm.io" # FQDN of your Chef Server
