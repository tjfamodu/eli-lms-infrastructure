...
CHEF_SERVER_NAME="Aaron-Eli-Test" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="aaron-eli-test-cgnvf9tw5oa4l1v4.us-east-1.opsworks-cm.io" # The FQDN of your Chef Server
